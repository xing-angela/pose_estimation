...
def _load_img_as_tensor(img_cv, image_size):
...
def load_video_frames(
    ...
    num_frames = len(images_cv)

    images = torch.zeros(num_frames, 3, image_size, image_size, dtype=torch.float32)
    for n, image_cv in enumerate(images_cv):
        images[n], video_height, video_width = _load_img_as_tensor(image_cv, image_size)
